package com.example.gaode_map.route;
...
import com.example.gaode_map.util.OffLineMapUtils;
	...
	public void onPoiSearched(PoiResult result, int rCode) {
		...
		if (rCode == 0) {// 返回成功
			if (result != null && result.getQuery() != null
				...
				ToastUtil.show(RouteActivity.this, "无结果");
			}
		} else if (rCode == 27) {
			ToastUtil.show(RouteActivity.this, "网络错误");
		} else if (rCode == 32) {
			ToastUtil.show(RouteActivity.this, "错误");
		} else {
			ToastUtil.show(RouteActivity.this, "其它错误");
		}
	}
