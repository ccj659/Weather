...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
	...
	public void onCreate(Bundle icicle) {
		...
		//cityBIZ.searchCityInfo(cityName);
		init();
		initListener();
		setStyleBasic();
		setStyleCustom();
	...
	private void setTag(){
		...
		if (TextUtils.isEmpty(tag)) {
			Toast.makeText(PushSetActivity.this,"空", Toast.LENGTH_SHORT).show();
			return;
		}
	...
	private void setStyleBasic(){
		...
		builder.statusBarDrawable = R.drawable.ico;
	...
	private void setStyleCustom(){
		...
		builder.layoutIconDrawable = R.drawable.org3_ww3;
